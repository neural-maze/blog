...
And ... yes! I'm using [Groq](https://groq.com/) for this application! The cool thing is that both the Suno API and Llama3-70B (using Groq) are completely free! Isn't that AMAZING?
